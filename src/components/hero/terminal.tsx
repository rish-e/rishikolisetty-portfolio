...
const NEOFETCH: Line[] = [
  ...
  { text: "      ██          ██      ", className: "text-blue-400" },
  { text: "    ██    ██████    ██    rishi@bangalore", className: "text-blue-400" },
  { text: "    ██  ██      ██  ██    ---------------", className: "text-blue-400" },
  ...
  { text: "                          Trading: Options + MACD/EMA", className: "text-yellow-400" },
  { text: "                          Languages: EN, ES (learning)", className: "text-yellow-400" },
  { text: "                          Theme: Dark [always]", className: "text-purple-400" },
  { text: "                          Uptime: shipping since 2022", className: "text-purple-400" },
  { text: "" },
...
function getWhoamiOutput(): Line[] {
  return [
    ...
    { text: "" },
    { text: "  Entrepreneur and builder based in Bangalore, India." },
    { text: "  Building across AI, fintech, fashion, and dev tools." },
    { text: "" },
    { text: "  Running Luami (premium nightwear) with a global team." },
    { text: "  Trading options. Learning Spanish. Shipping daily." },
    { text: "  4x MUN award winner. Shortlisted for Harvard MUN." },
    { text: "" },
  ];
}
...
const INTRO_LINES: Line[] = [
  ...
  { text: "" },
  { text: "  I'm Rishi — entrepreneur, builder, based in Bangalore." },
  { text: "  I build startups, trade options, and ship software daily." },
  { text: "" },
