...
import { Code2, Globe, Server, Brain, Cloud, Wrench, ChevronLeft, ChevronRight } from "lucide-react";
...
const panes: Pane[] = [
  { id: "languages", label: "Languages", icon: Code2, color: "bg-orange-500", items: ["TypeScript", "Python", "JavaScript", "Bash", "SQL"] },
  ...
  { id: "ai", label: "AI & ML", icon: Brain, color: "bg-purple-500", items: ["Claude API", "LLMs", "MCP", "AI SDK", "Prompt Engineering"] },
      ...
      <div className="w-56 shrink-0 border-r border-[#333] bg-[#252525] overflow-auto">
        ...
        <div className="border-b border-[#333] p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#888]">rishiOS v2025.4</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-2 space-y-0.5">
          {panes.map((pane) => (
            ...
            >
              <div className={cn("flex h-6 w-6 items-center justify-center rounded-md", pane.color)}>
                <pane.icon className="h-3.5 w-3.5 text-white" />
              </div>
        ...
        {activePane ? (
          <div className="p-6">
            <div className="flex items-center gap-3 mb-6">
              <div className={cn("flex h-8 w-8 items-center justify-center rounded-lg", activePane.color)}>
                <activePane.icon className="h-4 w-4 text-white" />
              </div>
